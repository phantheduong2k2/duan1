...
<div class="content-wrapper">
    ...
    <div class="card card-primary">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form action="index.php?act=add_nv" method="post" enctype="multipart/form-data" id="form_addnv">
            <div class="card-body">
                <div class="form-group">
                    <label for="">Mã Nhân Viên</label>
                    <input class="form-control" type="text" name="ma_nv" id="ma_nv">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="ten_nv" id="ten_nv" >
                </div>
                <div class="form-group">
